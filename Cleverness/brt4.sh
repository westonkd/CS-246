...
setupEnvironment()
{
   # put one line of shell code here (but NOT the setting of any environment variables!)
...
runProgram()
{
   java -ea BegatOMatic4
}

checkAndCompileProgram()
{
   if [ BegatOMatic4.java -nt BegatOMatic4.class ]
   then
      javac BegatOMatic4.java || exit 1
   fi
