...
####### DO NOT MODIFY ANYTHING IN THIS SCRIPT --- ONLY IN YOUR CODE!!! ########
...
runProgram()
{
   java -ea -Ddata="$data" BegatOMatic1
}

checkAndCompileProgram()
{
   if [ BegatOMatic1.java -nt BegatOMatic1.class ]
   then
      javac BegatOMatic1.java || exit 1
   fi
